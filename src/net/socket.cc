...
auto xyco::net::SocketAddrV6::get_port() const -> uint16_t { return inner_.sin6_port; }
...
auto xyco::net::SocketAddr::new_v4(Ipv4Addr ip_addr, uint16_t port) -> SocketAddr {
...
auto xyco::net::SocketAddr::new_v6(Ipv6Addr ip_addr, uint16_t port) -> SocketAddr {
...
xyco::net::Socket::Socket(Socket&& socket) noexcept : fd_(socket.fd_) { socket.fd_ = -1; }
